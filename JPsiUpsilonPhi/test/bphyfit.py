...
def main():
    ...
    for h in histos:
        ...
        nbkg1 = RooRealVar("bkg1","bkg1",10000,0.,30000)
        nbkg2 = RooRealVar("bkg2","bkg2",10000,0.,30000)
        ...
        bkg1 = RooChebychev("bkg1","bkg1",w.var('mass'),RooArgList(c1,c2,c3,c4))
        bkg2 = RooChebychev("bkg2","bkg2",w.var('mass'),RooArgList(a1,a2,a3,a4))
