...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     ...
     // if (jpipi_mass>4.1 &&jpipi_mass<5)  cout <<  "jpp mass is  " << jpipi_mass << endl;
      if (jpipi_mass>4.2 &&jpipi_mass<4.25)         mon.fillHisto("M_JPsiPicut4.20-4.25","total",(jpsi+pion1).M(),weight);
      if (jpipi_mass>4.25 &&jpipi_mass<4.3)         mon.fillHisto("M_JPsiPicut4.25-4.30","total",(jpsi+pion1).M(),weight);
      if (jpipi_mass>4.3 &&jpipi_mass<4.4)          mon.fillHisto("M_JPsiPicut4.30-4.40","total",(jpsi+pion1).M(),weight);
      if (jpipi_mass>4.4 &&jpipi_mass<4.7)          mon.fillHisto("M_JPsiPicut4.40-4.70","total",(jpsi+pion1).M(),weight);
      if (jpipi_mass>4.7 &&jpipi_mass<5.0)          mon.fillHisto("M_JPsiPicut4.70-5.00","total",(jpsi+pion1).M(),weight);
      if (jpipi_mass>4.00 &&jpipi_mass<4.20)        mon.fillHisto("M_JPsiPicut4.00-4.20","total",(jpsi+pion1).M(),weight);
