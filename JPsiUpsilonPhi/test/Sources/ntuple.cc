...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     ...
     // if (jpipi_mass>4.1 &&jpipi_mass<5)  cout <<  "jpp mass is  " << jpipi_mass << endl;
      if (jpipi_mass>4.0 &&jpipi_mass<4.1)         mon.fillHisto("M_JPsiPicut4.0-4.1","total",(jpsi+pion1).M(),weight);
      if (jpipi_mass>4.1 &&jpipi_mass<4.15)         mon.fillHisto("M_JPsiPicut4.1-4.15","total",(jpsi+pion1).M(),weight);
      if (jpipi_mass>4.15 &&jpipi_mass<4.2)         mon.fillHisto("M_JPsiPicut4.15-4.2","total",(jpsi+pion1).M(),weight);
      ...
      if (jpipi_mass>4.4 &&jpipi_mass<4.5)          mon.fillHisto("M_JPsiPicut4.4-4.5","total",(jpsi+pion1).M(),weight);
      if (jpipi_mass>4.5 &&jpipi_mass<4.7)          mon.fillHisto("M_JPsiPicut4.5-4.7","total",(jpsi+pion1).M(),weight);
