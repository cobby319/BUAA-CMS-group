...
bool SmartSelectionMonitor_hzz::declareHistos_jpsipipi(){
 ...
 addHistogram( new TH1F("M_JPsiPicut4.20-4.25",";m_{J/psi,Pi};Events",40,3.5,4.3)); 
 ...
 addHistogram( new TH1F("M_JPsiPicut4.25-4.30",";m_{J/psi,Pi};Events",40,3.5,4.3));
 addHistogram( new TH1F("M_JPsiPicut4.30-4.40",";m_{J/psi,Pi};Events",40,3.5,4.3)); 
 addHistogram( new TH1F("M_JPsiPicut4.40-4.70",";m_{J/psi,Pi};Events",40,3.5,4.3)); 
 addHistogram( new TH1F("M_JPsiPicut4.70-5.00",";m_{J/psi,Pi};Events",40,3.5,4.3)); 
 addHistogram( new TH1F("M_JPsiPicut4.00-4.20",";m_{J/psi,Pi};Events",40,3.5,4.3)); 
 addHistogram( new TH1F("M_JPsiPicut4.24-4.28",";m_{J/psi,Pi};Events",40,3.5,4.3)); 
