...
bool SmartSelectionMonitor_hzz::declareHistos_jpsipipi(){
 ...
 addHistogram( new TH1F("M_JPsi",";M_{J/#psi};Events",50,2.8,3.3));
 addHistogram( new TH1F("pT_JPsi",";p_{T,J/#Psi};Events",120,0,120)); 
 ...
 addHistogram( new TH1F("mumdxy",";;Events",10,-0.05,0.05)); 
 addHistogram( new TH1F("mupdxy",";;Events",10,-0.05,0.05)); 
 addHistogram( new TH1F("mumdz",";;Events",10,-0.05,0.05)); 
 addHistogram( new TH1F("mupdz",";;Events",10,-0.05,0.05)); 
 addHistogram( new TH1F("muon_dca",";;Events",10,0,0.1)); 
 addHistogram( new TH1F("mu1soft",";;Events",1,0,1)); 
 addHistogram( new TH1F("mu2soft",";;Events",1,0,1)); 
 addHistogram( new TH1F("mu1tight",";;Events",1,0,1)); 
 addHistogram( new TH1F("mu2tight",";;Events",1,0,1)); 
 addHistogram( new TH1F("mu1PF",";;Events",1,0,1)); 
 addHistogram( new TH1F("mu2PF",";;Events",1,0,1)); 
 addHistogram( new TH1F("mu1loose",";;Events",1,0,1)); 
 addHistogram( new TH1F("mu2loose",";;Events",1,0,1)); 
 addHistogram( new TH1F("J_lxy",";;Events",10,0,0.1)); 
 addHistogram( new TH1F("J_lxyErr",";;Events",10,0,0.005)); 
 addHistogram( new TH1F("J_vertexchi2",";;Events",20,0,4)); 
 addHistogram( new TH1F("Pi_dJP",";;Events",10,-0.1,0.1)); 
 addHistogram( new TH1F("JPi_lxy",";;Events",20,0,0.1)); 
 addHistogram( new TH1F("JPi_lxyErr",";;Events",20,0,0.0002)); 
 addHistogram( new TH1F("JPiPi_lxy",";;Events",20,0,0.1)); 
 addHistogram( new TH1F("JPiPi_lxyErr",";;Events",20,0,0.0002)); 
 addHistogram( new TH1F("JPiPi_x",";;Events",10,-0.05,0.05)); 
 addHistogram( new TH1F("JPiPi_y",";;Events",10,-0.05,0.05)); 
 addHistogram( new TH1F("JPiPi_z",";;Events",10,-0.05,0.05)); 
 ...
 addHistogram( new TH1F("Pi_eta1",";;Events",30,-3,3)); 
 addHistogram( new TH1F("Pi_eta2",";;Events",30,-3,3)); 
 addHistogram( new TH1F("Pi_phi1",";;Events",40,-4,4)); 
 ...
 addHistogram( new TH1F("Pi_dxy1",";;Events",10,0,0.1)); 
 addHistogram( new TH1F("Pi_dxy2",";;Events",10,0,0.1)); 
 addHistogram( new TH1F("Pi_dxyerr1",";;Events",10,0,0.1)); 
 addHistogram( new TH1F("Pi_dxyerr2",";;Events",10,0,0.1)); 
