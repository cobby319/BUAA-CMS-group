...
bool SmartSelectionMonitor_hzz::declareHistos_jpsipipi(){
 ...
 addHistogram( new TH1F("M_JPsiPiPi3-8",";M_{J/#psi#pi+#pi-};Events",500,3,8));
 addHistogram( new TH1F("M_JPsiPiPi4-5",";M_{J/#psi#pi+#pi-};Events",200,4,5));
 ...
 addHistogram( new TH2F("M_JpsiPi1&M_JpsiPi2",";m^{2}_{J/psi,Pi1};m^{2}_{J/psi,Pi2}",150,10,25,150,10,25));
 addHistogram( new TH2F("M_JpsiPi1&M_Pi1Pi2",";m^{2}_{#J/psi#pi_{1}};m^{2}_{#pi_{1}#pi_{2}}",150,10,25,150,0,6));
 ...
 addHistogram( new TH1F("Pi1_hcalFraction",";;Events",50,0,0.01));
 addHistogram( new TH1F("Pi2_hcalFraction",";;Events",50,0,0.01));
 addHistogram( new TH1F("Pi1_vertexNdof",";;Events",50,0,50));
 addHistogram( new TH1F("Pi2_vertexNdof",";;Events",50,0,50));
 addHistogram( new TH1F("Pi1_vertexNchi2",";;Events",100,0,20));
 addHistogram( new TH1F("Pi2_vertexNchi2",";;Events",100,0,20));
 addHistogram( new TH1F("Pi1_lambda",";;Events",100,-5,5));
 addHistogram( new TH1F("Pi2_lambda",";;Events",100,-5,5));
 addHistogram( new TH1F("Pi1_lambdaError",";;Events",50,0,0.01));
 addHistogram( new TH1F("Pi2_lambdaError",";;Events",50,0,0.01));
 addHistogram( new TH1F("Pi1_qoverp",";;Events",100,-5,5));
 addHistogram( new TH1F("Pi2_qoverp",";;Events",100,-5,5));
 addHistogram( new TH1F("Pi1_qoverpError",";;Events",50,0,0.02));
 addHistogram( new TH1F("Pi2_qoverpError",";;Events",50,0,0.02));
 addHistogram( new TH1F("Pi1_validTkFraction",";;Events",50,0,2));
 addHistogram( new TH1F("Pi2_validTkFraction",";;Events",50,0,2));
 addHistogram( new TH1F("Pi1_numberOfMothers",";;Events",10,0,10));
 addHistogram( new TH1F("Pi2_numberOfMothers",";;Events",10,0,10));
 addHistogram( new TH1F("Pi1_numberOfSourceCandidatePtrs",";;Events",10,0,10));
 addHistogram( new TH1F("Pi2_numberOfSourceCandidatePtrs",";;Events",10,0,10));
 addHistogram( new TH1F("Pi1_numberOfValidHitsOnTrack",";;Events",30,0,30));
 addHistogram( new TH1F("Pi2_numberOfValidHitsOnTrack",";;Events",30,0,30));
 addHistogram( new TH1F("Pi1_innerDetId",";;Events",2,0,2));
 addHistogram( new TH1F("Pi2_innerDetId",";;Events",2,0,2));
 addHistogram( new TH1F("Pi1_innerOk",";;Events",2,0,2));
 addHistogram( new TH1F("Pi2_innerOk",";;Events",2,0,2));
 addHistogram( new TH1F("Pi1_isCaloMuon",";;Events",2,0,2));
 addHistogram( new TH1F("Pi2_isCaloMuon",";;Events",2,0,2));
 addHistogram( new TH1F("Pi1_isConvertedPhoton",";;Events",2,0,2));
 ...
 addHistogram( new TH1F("Pi2_isJet",";;Events",2,0,2));
 addHistogram( new TH1F("Pi1_isLonglived",";;Events",2,0,2));
 addHistogram( new TH1F("Pi2_isLonglived",";;Events",2,0,2));
 addHistogram( new TH1F("Pi1_massConstraint",";;Events",2,0,2));
 addHistogram( new TH1F("Pi2_massConstraint",";;Events",2,0,2));
 addHistogram( new TH1F("J_Prob",";;Events",50,0,1));
 addHistogram( new TH1F("JPi_Prob",";;Events",50,0,1));
 addHistogram( new TH1F("JPiPi_Prob",";;Events",50,0,1));
 TH1F *h1 =(TH1F*) addHistogram( new TH1F("Pi1_pdgId",";;Events",3,0,3));
 h1->GetXaxis()->SetBinLabel(1,"211");
 h1->GetXaxis()->SetBinLabel(2,"-211");
 h1->GetXaxis()->SetBinLabel(3,"others");
 TH1F *h2 =(TH1F*) addHistogram( new TH1F("Pi2_pdgId",";;Events",3,0,3));
 h2->GetXaxis()->SetBinLabel(1,"211");
 h2->GetXaxis()->SetBinLabel(2,"-211");
 h2->GetXaxis()->SetBinLabel(3,"others");
 return true;           
}
