...
bool SmartSelectionMonitor_hzz::declareHistos_jpsipipi(){
 ...
 addHistogram( new TH1F("Pi1_hcalFraction",";;Events",50,0,2));
 addHistogram( new TH1F("Pi2_hcalFraction",";;Events",50,0,2));
 ...
 addHistogram( new TH1F("Pi1_lambdaError",";;Events",50,0,5));
 addHistogram( new TH1F("Pi2_lambdaError",";;Events",50,0,5));
 addHistogram( new TH1F("Pi1_qoverp",";;Events",100,-5,5));
 addHistogram( new TH1F("Pi2_qoverp",";;Events",100,-5,5));
 addHistogram( new TH1F("Pi1_qoverpError",";;Events",50,0,5));
 addHistogram( new TH1F("Pi2_qoverpError",";;Events",50,0,5));
