...
bool SmartSelectionMonitor_hzz::declareHistos_jpsipipi(){
 ...
 addHistogram( new TH1F("Num_J",";N_{J/#psi};Events",5,0,5));
 addHistogram( new TH1F("M_J",";M_{J/#psi};Events",50,2.8,3.3));
 addHistogram( new TH1F("pT_J",";p_{T,J/#Psi};Events",120,0,120)); 
 addHistogram( new TH1F("M_JPP3-8",";M_{J/#psi#pi+#pi-};Events",100,3,8));
 addHistogram( new TH1F("M_JPP4-5",";M_{J/#psi#pi+#pi-};Events",20,4,5));
 addHistogram( new TH1F("M_JPP4.20-4.25",";m_{J/psi,Pi};Events",40,3.5,4.3)); 
 ...
 addHistogram( new TH1F("M_JPP4.25-4.30",";m_{J/psi,Pi};Events",40,3.5,4.3));
 addHistogram( new TH1F("M_JPP4.30-4.40",";m_{J/psi,Pi};Events",40,3.5,4.3)); 
 addHistogram( new TH1F("M_JPP4.40-4.70",";m_{J/psi,Pi};Events",40,3.5,4.3)); 
 addHistogram( new TH1F("M_JPP4.70-5.00",";m_{J/psi,Pi};Events",40,3.5,4.3)); 
 addHistogram( new TH1F("M_JPP4.00-4.20",";m_{J/psi,Pi};Events",40,3.5,4.3)); 
 addHistogram( new TH1F("M_JPP4.24-4.28",";m_{J/psi,Pi};Events",40,3.5,4.3)); 
 addHistogram( new TH2F("M_JpsiPi1&M_JpsiPi2",";m^2_{J/psi,Pi1};m^2_{J/psi,Pi2}",100,0,50,100,0,50));
 return true;           
}
template<class T>
