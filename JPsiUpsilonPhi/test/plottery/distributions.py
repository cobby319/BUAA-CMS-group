...
histos= {'Pi_pt1_':'pT of track1','Pi_pt2_':'pT of track2','Pi_eta1_':'#eta of track1','Pi_eta2_':'#eta of track2','J_mass_':'dimuon invariant mass','pT_JPsi_':'dimuon pT','DeltaR_JpsiPi1_':'#DeltaR of J/#psi & track1','DeltaR_JpsiPi2_':'#DeltaR of J/#psi & track2','JPiPi_lxy_':'Transverse L_{xy}','Deta_JpsiPi1_':'#Delta#eta of J/#psi & track1','Deta_JpsiPi2_':'#Delta#eta of J/#psi & track2','Dphi_JpsiPi1_':'#Delta#phi of J/#psi & track1','Dphi_JpsiPi2_':'#Delta#phi of J/#psi & track2','mumNHits_':'#mu^{-} total hits','mumNPHits_':'#mu^{-} pixel hits','mupNHits_':'#mu^{+} total hits','mupNPHits_':'#mu^{+} pixel hits','mu1soft_':'muon1 soft ID','mu2soft_':'muon2 soft ID','mu1tight_':'muon1 tight ID','mu2tight_':'muon2 tight ID','mu1loose_':'muon1 loose ID','mu2loose_':'muon2 loose ID','J_vertexchi2_':'J/#psi vertex fit#chi^{2}','Pi_nhits1_':'#pi1 total hits','Pi_npixelhits1_':'#pi1 pixel hits','Pi_nhits2_':'#pi2 total hits','Pi_npixelhits2_':'#pi2 pixel hits','Pi_vertexchisq1_':'J/#psi+#pi vertex fit #chi^{2}','Pi_vertexchisq2_':'J/#psi+#pi#pi vertex fit #chi^{2}'}
